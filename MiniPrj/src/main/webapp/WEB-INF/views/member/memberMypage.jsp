...
<script>
  function showPopup() { window.open("${pageContext.request.contextPath }/views/ad_popup2.jsp", "a", "width=800, height=800, left=400, top=500"); }
  </script>
<!-- END: Scripts -->
	...
	<div class="dk-box-2">
			<div class="container">
				<div class="row vertical-gap justify-content-between">
						...
						<button class="dk-btn dk-btn-md" type="button" name="ad4_button" onclick="window.open('ad_popup.do','광고 신청하기','width=800, height=800, left=400, top=500,location=no,status=no,scrollbars=yes');">광고 신청하러가기</button>
				</div>		
			</div>
	</div>
