	...
	<div class="">
            <form action="php/contact.php" class="dk-form" method="post">
                <div class="row vertical-gap">
                    ...
                    <div class="col-md-6">
                        <input style = "width:30%;" type="text" name="pwd" class="form-control" aria-describedby="emailHelp" placeholder="store Name">
                    </div>
                    <div class="col-md-6">
                        <input style = "width:30%;" type="text" name="pwd" class="form-control" aria-describedby="emailHelp" placeholder="store Address">
                    </div>
                    <div class="col-md-6">
                        <input style = "width:30%;" type="text" name="pwd" class="form-control" aria-describedby="emailHelp" placeholder="file">
                    </div>
                    <div class="col-12">
